...
@pytest.mark.unit
def test_should_execute_success_legacy_handler():
...
@pytest.mark.unit
def test_should_execute_failure_legacy_handler():
    global called_on_success
    called_on_success = False
...
@pytest.mark.unit
def test_should_execute_success_legacy_handler_with_valid_parameters():
...
def test_should_execute_legacy_handler_with_one_int_additional_parameters(result):
    given_first_parameter = (1,)
...
@pytest.mark.unit
@pytest.mark.parametrize("result", [isSuccess, isFailure])
def test_should_execute_legacy_handler_with_a_list_additional_parameters(result):
    given_first_parameter = [1]
...
@pytest.mark.unit
def test_should_execute_success_legacy_handler_without_any_argument():
    global called_on_success
    called_on_success = False
...
@pytest.mark.parametrize("result", [isSuccess, isFailure])
def test_should_execute_legacy_handler_with_additional_and_non_required_parameters_result_first(
    result,
):
...
@pytest.mark.parametrize("result", [isSuccess, isFailure])
def test_should_execute_legacy_handler_with_additional_and_non_required_parameters_result_last(
    result,
):
...
@pytest.mark.parametrize("result", [isSuccess, isFailure])
def test_should_execute_legacy_handler_with_additional_and_non_required_parameters_result_middle(
    result,
):
...
@pytest.mark.parametrize("result", [isSuccess, isFailure])
def test_should_execute_legacy_handler_with_only_one_parameter(result):
    given_first_parameter = 1
...
@pytest.mark.parametrize("result", [isSuccess, isFailure])
def test_should_execute_legacy_handler_with_an_empty_list(result):
